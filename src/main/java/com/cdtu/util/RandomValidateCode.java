...
//			imgPath = GetRootPath.getRootPath(request) + File.separator + "uploadFile" + File.separator + "checkcode"
...
//			imgPath += File.separator + uuid + ".png";
//			request.getSession().setAttribute("checkCodePath", imgPath);
//			ImageIO.write(image, "png", new File(imgPath));
//			imgPath = File.separator + "checkcodefile" + File.separator + dateDirectory + File.separator + uuid
//					+ ".png";
		} catch (Exception e) {
			e.printStackTrace();
		}
